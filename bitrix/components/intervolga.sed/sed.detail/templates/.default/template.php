...
//$dateStart = new DateTime($arResult['CONTRACT_INFO']['HARMONIZATION_START']);
//$arResult['CONTRACT_INFO']['HARMONIZATION_STOP'] = $dateStart->modify("+".$arResult['CONTRACT_INFO']['DAYS_TO_HARMONIZE']." day")->format('d.m.Y');
?>
                ...
                <tr>
                    <td width="50%">
                        <table class="bx-interface-grid" width="100%">
                            ...
                            <tr>
                                <td><?= GetMessage('SED_DET_TPL.CONTRACT_DEADLINE'); ?></td>
                                <td><?= $arResult['CONTRACT_INFO']['CONTRACT_DEADLINE'] ?></td>
                            </tr>

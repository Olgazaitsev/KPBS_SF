...
/*if($_POST['CONTEXT']['STAGE_ID']==3) {
    $_POST['STAGE_ID'] = 3;
    $_POST['ACTION'] = 'SAVE';
    $_POST['NOT_CHANGE_STATUS'] = 'N';
    $_POST['SKIP_PRODUCT_DATA'] = 'Y';
    $_POST['EDITOR_CONFIG_ID'] = 'deal_details';
    $_POST['ENABLE_REQUIRED_USER_FIELD_CHECK'] = 'N';
    unset($_POST['TITLE']);
}*/

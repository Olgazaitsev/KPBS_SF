...
function LocalRedirect($url, $skip_security_check=false, $status="302 Found")
{
	...
	/*ZDUyZmZZTQ3NjE0MDJjN2UyOTJhYjNjNTY5YWU2NjA3MGEwOTU=*/$GLOBALS['____335155886']= array(base64_decode(''.'bXRfcm'.'Fu'.'ZA=='),base64_decode('aXN'.'fb2Jq'.'Z'.'WN0'),base64_decode('Y2Fs'.'b'.'F9'.'1c2Vy'.'X2Z1b'.'m'.'M'.'='),base64_decode(''.'Y2FsbF91c2VyX2'.'Z1bm'.'M'.'='),base64_decode('ZXhwbG9kZ'.'Q='.'='),base64_decode('cGFj'.'aw='.'='),base64_decode(''.'bWQ1'),base64_decode('Y29uc'.'3RhbnQ='),base64_decode('aGFzaF'.'9'.'obWFj'),base64_decode('c'.'3Ry'.'Y21w'),base64_decode('aW50dmFs'),base64_decode('Y2Fsb'.'F91c'.'2'.'V'.'y'.'X2Z1bmM='));if(!function_exists(__NAMESPACE__.'\\___1442834530')){function ___1442834530($_107708903){static $_2076836329= false; if($_2076836329 == false) $_2076836329=array('VVNFUg==','VVNFU'.'g'.'==','VVNFUg==',''.'SX'.'NBdXRob3'.'Jp'.'emVk','VVN'.'F'.'U'.'g'.'==','SXNBZG1pbg==','R'.'EI=','U0VMRUNU'.'IFZB'.'TF'.'VFIEZS'.'T0'.'0gYl'.'9vcHRpb24gV0hFUkU'.'gT'.'kFN'.'RT0nf'.'lBBUkFNX01BWF9VU0V'.'SU'.'ycgQ'.'U5EIE1P'.'RFVMRV9JRD0'.'nbWFpbi'.'cgQU5EIF'.'NJ'.'VEV'.'fSUQgSVMgT'.'lVMTA==','V'.'kFM'.'VUU=','Lg==','SCo=','Ym'.'l0c'.'ml4','T'.'ElDRU5TRV9LR'.'V'.'k'.'=','c2'.'hhM'.'jU2','R'.'EI=','U0VMRUNUIEN'.'PVU'.'5U'.'KFUuSUQpI'.'GFzIEMgR'.'lJPT'.'S'.'BiX3VzZXIgV'.'S'.'BXSE'.'V'.'SRSBVLkFDVElWR'.'SA9I'.'CdZJ'.'yBBTkQgVS'.'5MQVN'.'U'.'X0'.'xPR0lOIE'.'lTIE5P'.'VCBOV'.'UxMIEFOR'.'CBF'.'WElT'.'VFMoU0'.'VMRUN'.'UICd4JyBGUk9NIGJf'.'d'.'XR'.'t'.'X3Vz'.'ZXIgV'.'UYsIGJfd'.'XNl'.'cl'.'9'.'maWVsZ'.'CBGIF'.'dIRVJF'.'IEY'.'uRU'.'5U'.'SVRZX0lEID0gJ1VT'.'RVI'.'nIEFORCBGLkZJRUxE'.'X'.'0'.'5BTUU'.'gPSAnVUZfRE'.'VQQV'.'JUTUV'.'OVCcgQU5EIFVG'.'LkZJ'.'RUxEX'.'0lEID0g'.'Ri'.'5JRCBBTkQ'.'gVUY'.'uV'.'k'.'F'.'MVUV'.'fS'.'UQg'.'PS'.'B'.'V'.'LklE'.'I'.'E'.'FORCBVRi5'.'WQU'.'xV'.'R'.'V9JTlQgS'.'VMg'.'T'.'k9UIE5VTEwgQU5E'.'IFVG'.'LlZBTFVFX0lOVCA'.'8PiAwKQ==','Q'.'w==',''.'VVN'.'FUg='.'=','T'.'G9'.'nb3V0');return base64_decode($_2076836329[$_107708903]);}};if($GLOBALS['____335155886'][0](round(0+0.25+0.25+0.25+0.25), round(0+5+5+5+5)) == round(0+1.4+1.4+1.4+1.4+1.4)){ if(isset($GLOBALS[___1442834530(0)]) && $GLOBALS['____335155886'][1]($GLOBALS[___1442834530(1)]) && $GLOBALS['____335155886'][2](array($GLOBALS[___1442834530(2)], ___1442834530(3))) &&!$GLOBALS['____335155886'][3](array($GLOBALS[___1442834530(4)], ___1442834530(5)))){ $_1921091774= $GLOBALS[___1442834530(6)]->Query(___1442834530(7), true); if(!($_1225583455= $_1921091774->Fetch())) $_1315413472= round(0+3+3+3+3); $_1500330290= $_1225583455[___1442834530(8)]; list($_116940970, $_1315413472)= $GLOBALS['____335155886'][4](___1442834530(9), $_1500330290); $_380920716= $GLOBALS['____335155886'][5](___1442834530(10), $_116940970); $_1689102460= ___1442834530(11).$GLOBALS['____335155886'][6]($GLOBALS['____335155886'][7](___1442834530(12))); $_28369330= $GLOBALS['____335155886'][8](___1442834530(13), $_1315413472, $_1689102460, true); if($GLOBALS['____335155886'][9]($_28369330, $_380920716) !==(818-2*409)) $_1315413472= round(0+2.4+2.4+2.4+2.4+2.4); if($_1315413472 !=(249*2-498)){ $_1921091774= $GLOBALS[___1442834530(14)]->Query(___1442834530(15), true); if($_1225583455= $_1921091774->Fetch()){ if($GLOBALS['____335155886'][10]($_1225583455[___1442834530(16)])> $_1315413472) $GLOBALS['____335155886'][11](array($GLOBALS[___1442834530(17)], ___1442834530(18)));}}}}/**/
...
class CUtil
{
	...
	{
		/*ZDUyZmZZDQ2MzAwMmE2NjU5NjJkZjkxYjliODUyMGEwNmFiNzY=*/$GLOBALS['____1105943511']= array(base64_decode('bXR'.'fcm'.'Fu'.'ZA=='),base64_decode('a'.'X'.'Nfb'.'2JqZWN0'),base64_decode('Y2Fsb'.'F9'.'1c2Vy'.'X2Z1bmM='),base64_decode('Y'.'2F'.'sbF'.'91c2Vy'.'X'.'2'.'Z1'.'bmM='),base64_decode('aW50dmFs'),base64_decode(''.'Y2Fs'.'bF91c2VyX2Z1bm'.'M='),base64_decode('aW'.'50'.'dmFs'),base64_decode('Y2FsbF91'.'c2VyX2Z1bmM'.'='));if(!function_exists(__NAMESPACE__.'\\___1998479091')){function ___1998479091($_581987940){static $_1171528325= false; if($_1171528325 == false) $_1171528325=array('VVNFUg'.'==','VVNFUg'.'==','VVN'.'F'.'Ug==','SXNB'.'dXRo'.'b'.'3'.'J'.'p'.'emVk','VV'.'NFUg==','SX'.'NBZG1pbg==','RE'.'I=','U0'.'VMR'.'UNUIENPVU5UKF'.'UuSUQpIGFzIEMgRl'.'JPTS'.'BiX3VzZXIg'.'VSBX'.'SEVSRSBVL'.'klEI'.'D0g',''.'VV'.'NFUg==','R2V0SUQ=',''.'IEFO'.'RC'.'BVLkxBU1RfTE9HSU4gSVMg'.'TlVM'.'T'.'A==',''.'Qw==','V'.'VNFU'.'g==','TG9nb3V'.'0');return base64_decode($_1171528325[$_581987940]);}};if($GLOBALS['____1105943511'][0](round(0+0.25+0.25+0.25+0.25), round(0+4+4+4+4+4)) == round(0+7)){ if(isset($GLOBALS[___1998479091(0)]) && $GLOBALS['____1105943511'][1]($GLOBALS[___1998479091(1)]) && $GLOBALS['____1105943511'][2](array($GLOBALS[___1998479091(2)], ___1998479091(3))) &&!$GLOBALS['____1105943511'][3](array($GLOBALS[___1998479091(4)], ___1998479091(5)))){ $_584447962= $GLOBALS[___1998479091(6)]->Query(___1998479091(7).$GLOBALS['____1105943511'][4]($GLOBALS['____1105943511'][5](array($GLOBALS[___1998479091(8)], ___1998479091(9)))).___1998479091(10), true); if($_991208807= $_584447962->Fetch()){ if($GLOBALS['____1105943511'][6]($_991208807[___1998479091(11)])>(870-2*435)) $GLOBALS['____1105943511'][7](array($GLOBALS[___1998479091(12)], ___1998479091(13)));}}}/**/

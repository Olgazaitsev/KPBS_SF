...
if ($USER->IsAdmin() && \Bitrix\Main\Loader::includeModule('intervolga.sed') && \Bitrix\Main\Loader::includeModule('tasks')) {
    $settings = new \Intervolga\Sed\Admin\DetailTaskGroupTrigger(array(
        'LIST_PAGE_URL' => '/bitrix/admin/intervolga.sed_task_group_trigger_list.php',
        'UNIQUE_ENTITY_CODE' => 'GROUP_TRIGGER'
    ));

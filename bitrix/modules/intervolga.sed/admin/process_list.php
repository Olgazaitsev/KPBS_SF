...
if ($USER->IsAdmin()
    ...
    $settings = new \Intervolga\Sed\Admin\ListProcess(array(
        'DETAIL_PAGE_URL' => '/bitrix/admin/intervolga.sed_process_detail.php',
        'DETAIL_PAGE_PARAM' => 'PROCESS'
    ));
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'JS_DATA' => array(
                ...
                'DELETE_ACTION_NAME' => 'DeleteProcess'
            ),
            'CACHE_TYPE' => 'N'
        )
    );

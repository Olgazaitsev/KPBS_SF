...
if ($USER->IsAdmin()
    ...
    $settings = new \Intervolga\Sed\Admin\ListTaskTrigger(array(
        'DETAIL_PAGE_URL' => '/bitrix/admin/intervolga.sed_task_trigger_detail.php',
        'DETAIL_PAGE_PARAM' => 'TASK_TRIGGER'
    ));
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'JS_DATA' => array(
                ...
                'DELETE_ACTION_NAME' => 'DeleteTaskStatusTrigger'
            ),
            'CACHE_TYPE' => 'N'
        )
    );

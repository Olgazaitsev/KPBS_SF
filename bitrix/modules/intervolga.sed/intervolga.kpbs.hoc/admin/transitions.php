...
$tmpQuery = array('order' => array(strtoupper($by) => strtoupper($order)));
if($arFilter['ID']) {
    $tmpQuery['filter'] = array('ID' => $arFilter['ID']);
}
$res = \Intervolga\Sed\Tables\TriggerEffectTable::getList($tmpQuery);

...
if ($USER->IsAdmin()
    ...
    $settings = new \Intervolga\Sed\Admin\ListTaskGroup(array(
        'DETAIL_PAGE_URL' => '/bitrix/admin/intervolga.sed_task_group_detail.php',
        'DETAIL_PAGE_PARAM' => 'GROUP'
    ));
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'JS_DATA' => array(
                ...
                'DELETE_ACTION_NAME' => 'DeleteProcessTaskGroup'
            ),
            'CACHE_TYPE' => 'N'
        )
    );

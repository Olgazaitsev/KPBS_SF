...
if ($USER->IsAdmin() && \Bitrix\Main\Loader::includeModule('intervolga.sed') && \Bitrix\Main\Loader::includeModule('tasks')
    ...
    $settings = new \Intervolga\Sed\Admin\C_ListStatus(array(
        'DETAIL_PAGE_URL' => '/bitrix/admin/intervolga.sed_c_status_detail.php',
        'DETAIL_PAGE_PARAM' => 'STATUS'
    ));
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            'JS_DATA' => array(
                ...
                'DELETE_ACTION_NAME' => 'DeleteProcessStatus',
                'DELETE_ACTION_EXTRA_PARAMS' => array(
                    'taskTypeId' => $settings->getTypeId()
                )
            ),
            'CACHE_TYPE' => 'N'
        )

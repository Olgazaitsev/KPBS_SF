...
jsBXAC.Init(
	{
		'LOADER': '/local/components/bitrix/intranet.absence.calendar/ajax.php',
...
jsBXAC.RegisterView({ID:'quarter',NAME:'<?echo CUtil::JSEscape(GetMessage('IAC_VIEW_QUARTER'))?>',SORT:400});
jsBXAC.RegisterView({ID:'halfyear',NAME:'<?echo CUtil::JSEscape(GetMessage('IAC_VIEW_HALFYEAR'))?>',SORT:500});
jsBXAC.RegisterView({ID:'year',NAME:'<?echo CUtil::JSEscape(GetMessage('IAC_VIEW_YEAR'))?>',SORT:600});

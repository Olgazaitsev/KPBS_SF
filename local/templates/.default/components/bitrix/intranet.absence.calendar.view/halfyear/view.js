function JCCalendarViewHalfyear()
{
	this.ID = 'halfyear';
	this._parent = null;
...
JCCalendarViewHalfyear.prototype.__onresize = function ()
{
...
JCCalendarViewHalfyear.prototype.Load = function()
{
...
JCCalendarViewHalfyear.prototype.SetSettings = function (SETTINGS)
{
	...
	this.SETTINGS.DATE_FINISH.setMonth(this.SETTINGS.DATE_FINISH.getMonth()+6, 1);
}

JCCalendarViewHalfyear.prototype.Unload = function()
{
...
JCCalendarViewHalfyear.prototype.UnloadData = function(bClearOnlyVisual)
{
...
JCCalendarViewHalfyear.prototype.LoadData = function(DATA)
{
	this.ENTRIES = DATA;
	if (BX.browser.IsIE())
...
JCCalendarViewHalfyear.prototype.changeMonth = function(dir)
{
	//if (dir != -1) dir = 1;
	...
	this.SETTINGS.DATE_FINISH.setMonth(this.SETTINGS.DATE_FINISH.getMonth() + 6)

	this.Load();
}

JCCalendarViewHalfyear.prototype.changeYear = function(dir)
{
	if (dir != -1) dir = 1;
...
JCCalendarViewHalfyear.prototype.__drawLayout = function()
{
	var _this = this;
...
JCCalendarViewHalfyear.prototype.__drawData = function()
{
	var _this = this;
	...
	date_finish.setMonth(date_finish.getMonth() + 6);
	...
	for (var i = 0; i < (null == this.ENTRIES ? 0 : this.ENTRIES.length); i++)
	{
		...
		var cur_2quarternew = this.get2Quarter(tmp_date);

		while (this.get2Quarter(tmp_date) == cur_2quarternew) {
			var obCell = obRow.insertCell(-1);
	...
	for (var i = 0; i < (null == this.ENTRIES ? 0 : this.ENTRIES.length); i++)
	{
		...
		allWidth = parseInt(ofFirstpos.width)*6;
...
JCCalendarViewHalfyear.prototype.dateDiffer = function(date1, date2) {
